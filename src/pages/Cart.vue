        ...
        <div  class="delivery-form">
            ...
            <form class="mt-3" @submit.prevent="pushIntoOrder">
                ...
                <div class="orm-group mt-2">
                    ...
                    <div id="emailHelp" class="form-text"> <em> Non condivideremo mai la tua mail con altre persone.</em></div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <router-link class="ms-2 btn btn-restaurant2" :to="{name: 'restaurant'}" @click="clearCart()">Elimina Carrello</router-link>
                </div>
            </form>
